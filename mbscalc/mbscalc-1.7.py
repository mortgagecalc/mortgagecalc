    ...
    <head>
        ...
        <script>
            ...
            function check() {
                ...
                if (arrayeq(cdr, 5)) {
                    if (arrayeq(cpr, 2)) {data=CPR02CDR05; document.getElementById('radio6').checked = true; reDraw(); }
    ...
    <body style="font-size:62.5%;">
        ...
        <div id="accordion2">
            ...
            <div>
                ...
                <div '''+loadml+'''>
                    <span id="fixcdr">
                        <input type="radio" id="radio6" name="radio" onclick="data=CPR02CDR05; reDraw();" checked="checked" /><label for="radio6">02CPR:05CDR</label>
