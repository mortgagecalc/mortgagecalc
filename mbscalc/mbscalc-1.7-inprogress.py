    ...
    <head>
        ...
        <script>
            ...
            function check() {
                ...
                if (arrayeq(cdr, 5)) {
                    if (arrayeq(cpr, 2)) {data=CPR02CDR05; reDraw(); }
                    else if (arrayeq(cpr, 4)) {data=CPR04CDR05; reDraw(); }
                    else if (arrayeq(cpr, 6)) {data=CPR06CDR05; reDraw(); }
                    else if (arrayeq(cpr, 8)) {data=CPR08CDR05; reDraw(); }
                    else if (arrayeq(cpr, 10)) {data=CPR10CDR05; reDraw(); } }
                else if (arrayeq(cpr, 2)) {
                    if (arrayeq(cdr, 6)) {data=CPR02CDR06; reDraw(); }
                    else if (arrayeq(cdr, 8)) {data=CPR02CDR08; reDraw(); }
                    else if (arrayeq(cdr, 10)) {data=CPR02CDR10; reDraw(); }
                    else if (arrayeq(cdr, 12)) {data=CPR02CDR12; reDraw(); }
                    else if (arrayeq(cdr, 14)) {data=CPR02CDR14; reDraw(); } } }
		...
		$("#cdr > span").each(function() {
			...
			$( this ).empty().slider({
				...
				slide: function(event, ui) {check(); $(".ui-slider-handle,a").css("text-decoration", "none").css("text-align", "center").text(ui.value);},
				stop: function(event, ui) {check(); $(".ui-slider-handle,a").css("text-decoration", "none").css("text-align", "center").text(ui.value);}
			}); });
