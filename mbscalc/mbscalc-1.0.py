...
class MainPage(webapp.RequestHandler):
    def get(self):
        ...
        if (useremail == 'alex@chilmarkhill.com' or
            useremail == 'james@chilmarkhill.com' or
            useremail == 'jake@chilmarkhill.com'):
        ...
        self.response.out.write('''
              <html>
                ...
                <body>
                    ...
                    <table align="center" cellpadding="10">
                    <tr><th>Input Data<br />(date, principal, interest)</th><th><textarea name="inputdata" rows="10" cols="50">01/01/11, 120, 10
02/01/11, 125, 15
03/01/11, 150, 20
04/01/11, 155, 20
05/01/11, 140, 20
...
10/01/11, 135, 15</textarea></th></tr>
    ...
    def post(self):
        ...
        <form action="/grapher" method="post">
        <table align="center" cellpadding="10">
        <tr><th>Input Data<br />(date, principal, interest)</th><th><textarea name="inputdata" rows="10" cols="50">'''+self.request.get('inputdata')+'''</textarea></th></tr>
        <tr><td colspan="2"><p style="font-size:10px; text-align:center;">Every line requires all three values separated by commas. Enter 0 if there is no principal and/or interest.<br />
        Make sure there is no extra empty line at end of dataset.</p></td></tr>
        <tr><th colspan="2"><input type="submit" value="Graph Cash Flow" /></th></tr>
        </table>
